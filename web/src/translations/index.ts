...
export const languageTranslation: Translation = { english: 'Language', estonian: 'Keel', russian: 'Язык' };
export const themeTranslation: Translation = { english: 'Theme', estonian: 'Teema', russian: 'Тема' };

export const homeTranslation: Translation = { english: 'Home', estonian: 'Kodu', russian: 'Дом' };
export const moviesTranslation: Translation = { english: 'Movies', estonian: 'Filmid', russian: 'Фильмы' };

export const welcomeTranslation: Translation = { english: 'Hello!', estonian: 'Tere!', russian: 'Привет!' };
export const noTimeInfoTranslation: Translation = {
  english: 'I do not have the time to design a good landing page. This home page only exists to demonstrate navigation.',
  estonian: 'Ma ei ole aega disainida hea landing page. See koduleht on ainult näitamaks navigeerimist.',
